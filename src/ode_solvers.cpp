...
double runge_kutta_1(const std::function<double(double,double)> F, const double t, const double y, const double h){
...
void runge_kutta_2(const std::function<double(double,double,double)> f1, const std::function<double(double,double,double)> f2,
	const double t, const double x1, const double x2, const double h, double *x1_, double *x2_){
